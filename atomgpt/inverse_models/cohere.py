...
try:
    ...
    if not transformers_version >= Version("4.42"):
        raise ImportError(
            f"AtomGPT: Your transformers version of {transformers_version} does not support Cohere.\n"
...
def CohereDecoderLayer_fast_forward(
    ...
    **kwargs,
    ...
    if use_cache and hasattr(
        ...
        hidden_states_attention, self_attn_weights, present_key_value = (
            self.self_attn(
        ...
        residual = hidden_states
        hidden_states = fast_layernorm_compiled(
