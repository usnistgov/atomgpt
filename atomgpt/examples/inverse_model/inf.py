...
m_test = make_alpaca_json(dataset=dat, jids=test_ids, prop="prop",include_jid=True)
...
path = '/wrk/knc6/AtomGPT/SuperCon/atomgpt_bulk_gen_supercon/lora_model_m'
...
prompt_example = "The chemical formula is YCI The  Tc_supercon is 6.483. The spacegroup is 12. Generate atomic structure description with lattice lengths, angles, coordinates and atom types."
