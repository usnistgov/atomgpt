...
if __name__ == "__main__":
    ...
    run(
        model_name="formula_output_dir_dft_2d_unsloth/Llama-3.2-11B-Vision-Instructold/checkpoint-620",
        datasets=["dft_2d"],
    )
    # run(model_name="unsloth/Llama-3.2-11B-Vision-Instruct",datasets=["dft_2d"])
